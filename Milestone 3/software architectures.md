...
For our project, the microservices architecture is chosen because it provides the right combination of scalability, clarity of component separation, and direct compatibility with future milestones. It is complex enough to showcase solid design and implementation skills, yet feasible for a small development team to implement successfully using Docker and REST-based communication.# Milestone 3
